...
import com.zhuangxv.bot.api.support.Kick;
...
public class Member implements Contact {
    ...
    @Async("taskExecutor")
    public void updateThisCard(String card) {
        this.card = card;
    }


    public void invokeg(BaseApi baseApi) {
        this.bot.invoke(baseApi);
    }
    ...
    @Async("taskExecutor")
    public void kick() {
        this.bot.invoke(new Kick(this.groupId, this.userId));
    }
